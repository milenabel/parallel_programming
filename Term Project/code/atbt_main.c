// Use "gcc -O3 -fopenmp atbt_main.c atbt_par.c " or
// or use "clang -O3  -fopenmp atbt_main.c atbt_par.c" to compile
...
int main(int argc, char *argv[]){
  ...
  printf("Reference sequential code for ATBT: Time = %.2f sec; Performance (in GFLOPS): %.2f\n",t_seq,2.0e-9*Ni*Nj*Nk/t_seq);
